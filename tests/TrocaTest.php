...
class TrocaTest extends TestCase
{
    ...
    public function testUpdateTrocaAutorizada()
    {
        $troca= \App\Troca::first();
        ...
        $this->put('/api/trocas/autorizar/'.$troca->id, $dados, $this->api_token);
    ...
    public function testUpdateTrocaCancelada()
    {
        $troca= \App\Troca::first();
        ...
        $this->put('/api/trocas/cancelar/'.$troca->id, $dados, $this->api_token);
    ...
    public function testUpdateTrocaConcluida()
    {
        $troca= \App\Troca::first();
        ...
        $this->put('/api/trocas/concluir/'.$troca->id, $dados, $this->api_token);
    ...
    public function testUpdateTrocaPendente()
    {
        $troca= \App\Troca::first();
        ...
        $this->put('/api/trocas/pendente/'.$troca->id, $dados, $this->api_token);
